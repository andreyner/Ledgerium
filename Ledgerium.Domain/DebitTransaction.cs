...
{
    public DebitTransaction(Guid id, Guid clientId, DateTimeOffset occurredAt, decimal amount, DateTimeOffset insertedAt,bool isReverted, DateTimeOffset? revertedAt)
